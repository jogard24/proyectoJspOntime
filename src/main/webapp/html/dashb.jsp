...
<html lang="es">
  ...
  <body>
    <section class="dash">
      ...
      <section class="contenedor-menu">
        <aside class="menu-lateral">
          ...
          <nav class="menu">
            <button class="bt-home bt-menu-item" id="btn-home">🏛️ ​ HOME</button>
            <button
              type="button"
              class="bt-menu-item"
              id="btn-gestionEmpleados"
            >
              Gestion empleados
            </button>
            <button type="button" class="bt-menu-item" id="btn-Registro">
              ​Registro
            </button>
            ...
            <button type="button" class="bt-menu-item" id="btn-Informes">
              Horario
            </button>
    ...
    <div style="background:white; width:min(90vw, 560px); max-width:560px; margin:80px auto; padding:24px; border-radius:12px; box-shadow:0 24px 48px rgba(0,0,0,0.28);">
      ...
      <div style="display:flex; gap:16px; align-items:flex-start; flex-wrap:wrap; margin-bottom:12px;">
        <div style="display:flex; flex-direction:column; align-items:center; gap:10px; min-width:120px;">
          <img id="previewEditFoto" src="../img/higuita.jpg" alt="vista previa" style="width:88px; height:88px; border-radius:50%; object-fit:cover; border:1px solid rgba(0,0,0,0.15);">
      ...
      <div style="display:flex; gap:8px; justify-content:flex-end; margin-top:12px;">
        ...
        <button onclick="guardarEdicion()" style="padding:8px 12px; border-radius:6px; background:var(--blue); color:#fff; border:none;">Guardar Cambios</button>
      </div>
    </div>
  </div>
